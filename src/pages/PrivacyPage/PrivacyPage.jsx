        ...
        <div className={styles.politics}>
          <div>
            ...
            <p>
              ...
              соответствии с требованиями закона Республики Казахстан № 94-V от
              01.05.2013 «О персональных данных» (далее — Закон о персональных
            ...
            <p>
              ...
              их доступность в сети интернет по сетевому адресу https://daar.kz
            </p>
            <p>
            ...
            <p>
              2.10. Пользователь — любой посетитель веб-сайта https://daar.kz
            </p>
            <p>
            ...
            <p>
              ...
              данных, за исключением случаев, предусмотренных законами РК.
            ...
            <p>
              ...
              целей, предусмотренных международным договором РК или законом, для
              осуществления возложенных законодательством РК на оператора
            ...
            <p>
              ...
              законодательством РК об исполнительном производстве.
            </p>
            <p>
            ...
            <p>
              ...
              Оператора daar.kazakhstan@gmail.com с пометкой «Актуализация
              персональных данных».
            </p>
            <p>
              ...
              Оператора daar.kazakhstan@gmail.com с пометкой «Отзыв согласия на
            ...
            <p>
              ...
              сети Интернет по адресу https://daar.kz/politics/
            </p>
          </div>
        </div>
      </Content>
